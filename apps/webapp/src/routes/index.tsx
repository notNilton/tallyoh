...
import { ArrowDownLeft, ArrowUpRight, Loader2, ShieldCheck, Wallet } from 'lucide-react';
        ...
        <FinancialSummaryPanel
          ...
          stats={[
            ...
            },
            {
              title: 'Receitas',
              value: (
                <PrivacyAmount value={dashboard.monthlyIncome} className="font-display text-emerald-600" />
              ),
              icon: ArrowUpRight,
              tone: 'income',
              className: 'w-[220px] shrink-0 snap-start sm:w-auto',
            },
            {
              title: 'Despesas',
              value: (
                <PrivacyAmount value={dashboard.monthlyExpenses} className="font-display text-rose-600" />
              ),
              icon: ArrowDownLeft,
              tone: 'expense',
              className: 'w-[220px] shrink-0 snap-start sm:w-auto',
